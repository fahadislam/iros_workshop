...
Oren Salzman {\normalfont and}
Maxim Likhachev
\thanks{This research was in part sponsored by ARL, under the Robotics CTA program grant W911NF-10-2-0016.
}
\\
...
\begin{figure*}[!ht]
 \subfloat[\label{fig:success}]{%
   \includegraphics[width=0.47\textwidth]{success.png}
 }
 \hfill
 \subfloat[\label{fig:memory}]{%
   \includegraphics[width=0.47\textwidth]{memory.png}
 }
