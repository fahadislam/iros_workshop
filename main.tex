...
\Procedure{FindGreedyPath}{$s_1, s_2$}
	...
	\While{$s_{\text{curr}} \neq s_2$}
    	...
    	\State $s_{\text{curr}} \leftarrow \argmin\limits_{s \in \text{Preds}(s_{\text{curr}})} h(s, s_2)$ 	\Comment{greedy predecessor}
    \EndWhile
    \State \Return $\pi$
\EndProcedure
