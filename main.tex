  ...
  % \begin{center}
    \resizebox{\textwidth}{!}{%
      \begin{tabular}{ l | c c c  c c c  c c c  c  c}
       ...
       \hline
       Planning time [ms]& 15.2 (25.5) & - (-) & - (-) & 15.9 (31.4) & - (-) & - (-) & - (-) & 459.1 (3063.65) & 0.42 (0.7)\\
       Success rate [$\%$]& 98 & - & - & 90.5 & - & - & - & 98 & 100\\
       Memory usage [Mb] & 724 & - & - & 118 & - & - & - & - & 7.8\\
      \end{tabular}
  }
...
For our method, preprocessing (Alg.~\ref{alg:1}) took 1,569 seconds and returned 504 subregions. For precomputing paths (Alg.~\ref{alg:1}, line~\ref{alg:1:pp}), we use \textsf{RRT}-Connect. 
From the results we observe that our method shows a speedup of over tenfold in query time as compared to other multi-query planners primarily because it doesn't require collision checking. RRT-Connect being a single-query planner is orders of magnitude slower.
