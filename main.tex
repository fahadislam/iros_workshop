...
\section {Analysis}
{\color{blue} TODO}\\
1. A greedy search from every reachable state towards the corresponding attractor state will be monotonically decreasing in the heuristic values.\\
2. All the states with heuristic values less than R are reachable\\
3. Alg. 2 returns the maximum radius R within which all the states with heuristic values less than R are reachable. 
