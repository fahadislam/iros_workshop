...
{\color{blue}While there are planners that guarantee real-time performance by limiting the planning horizon, we are not aware of general purpose planners capable of doing it for infinite horizon (i.e planning to the goal).}
%
