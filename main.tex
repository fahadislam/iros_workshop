...
As our heuristic function is weakly monotonic (Assumption~\textbf{A2}), the value of $r_i$ monotonically increases as the algorithm adds sates to $S_{\text{reachable}}$ (Line~\ref{alg:2:rad}).
